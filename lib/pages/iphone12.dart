...
class iphone12 extends StatefulWidget {
  @override
  _iphone12State createState() => _iphone12State();
}

class _iphone12State extends State<iphone12> {
  @override
        ...
        body: ListView(
          children: [
            Container(
              ...
              child: GridTile(
                child: Image.network(
                    "https://img.phonandroid.com/2020/10/iphone12-pro-max.jpg",
                    fit: BoxFit.cover),
                footer: Container(
                    height: 60,
