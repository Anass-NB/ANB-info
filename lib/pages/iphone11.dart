...
class iphone11 extends StatefulWidget {
  @override
  _iphone11State createState() => _iphone11State();
}

class _iphone11State extends State<iphone11> {
  @override
        ...
        body: ListView(
          children: [
            Container(
              ...
              child: GridTile(
                child: Image.network(
                    "https://3edda.com/system/mobile_images/images/000/001/451/original/2.jpg?1615067083",
                    fit: BoxFit.cover),
                footer: Container(
                    height: 60,
